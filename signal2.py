...
def update_plot(frame):
    with _lock:
        ...
        axes[0].set_title("RSSI (Received Signal Strength, dBm)")
        axes[1].set_title("SNR (Signal-to-Noise Ratio, dB)")
        axes[2].set_title("SRRI (Scaled SNR, 0–100)")
        axes[2].set_xlabel("Aika (s, viimeiset ~60)")
